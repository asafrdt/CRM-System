    ...
    public partial class GeneralWorkHours : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand(@"select Username as 'User name', shift_date as 'Shift date', logtimeIn as 'Login time', logtimeOut as 'Logout time',CalculateHours as 'Shift Hours' FROM Work_card WHERE Username='" + Login.UserID + "' AND Year = '" + comboBox2.Text + "' AND Month = '" + comboBox3.Text + "'", con);
