...
{
    public partial class GeneralPrivateArea : Form
    {
        public GeneralPrivateArea()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            foreach (Form f in Application.OpenForms)
                if (f.Name == "Checkout" || f.Name == "Employees" || f.Name == "Stock_Suppliers" || f.Name == "Costumers_Orders"
                    ...
                    || f.Name == "GeneralWorkHours" || f.Name == "MyStockControlPage"
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            foreach (Form f in forms)
                f.Close();
            GeneralWorkHours mm = new GeneralWorkHours();
            mm.Show();
        }
    }
}
